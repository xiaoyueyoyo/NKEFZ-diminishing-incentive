...
gen OPEN = log(0.1*经营单位/年末常住)  //由占gdp比重改为人均美元
gen FCR = 森林
gen SO2 = log(二氧化硫*10e6/年末常住)  //由人均kg改为人均g
...
xtreg LGEE lowEFT highEFT high,fe r   //lowEFT highEFT 均显著。其他控制变量省略。
xtreg LGEE lowEFT highEFT high GDP SUF URB EDU OPEN IND,fe r  //加入控制变量
xi: xtreg LGEE lowEFT highEFT high GDP SUF URB EDU OPEN IND i.year,fe r  //加入时间效应
